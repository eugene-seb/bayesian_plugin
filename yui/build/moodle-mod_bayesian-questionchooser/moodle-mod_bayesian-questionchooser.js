YUI.add('moodle-mod_bayesian-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_bayesian-questionchooser'
});

M.mod_bayesian = M.mod_bayesian || {};
M.mod_bayesian.init_questionchooser = function() {
    M.mod_bayesian.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_bayesian.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_bayesian-util", "querystring-parse"]});
