YUI.add('moodle-mod_bayesian-bayesianbase', function (Y, NAME) {

/**
 * The bayesianbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_bayesian-bayesianbase
 */
var bayesianBASENAME = 'mod_bayesian-bayesianbase';

var bayesianBASE = function() {
    bayesianBASE.superclass.constructor.apply(this, arguments);
};
 ...
 */
M.mod_bayesian.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_bayesian.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
