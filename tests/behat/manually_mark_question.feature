...
Feature: Teachers can override the grade for any question
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | bayesian       | bayesian 1 | bayesian 1 description | C1     | bayesian1    | 20    |
  ...
  Scenario: Validating the marking of an essay question attempt.
    When I am on the "bayesian 1 > student1 > Attempt 1" "mod_bayesian > Attempt review" page logged in as "teacher1"
  ...
  Scenario: Comment on a response to an essay question attempt.
    ...
    And I upload "mod/bayesian/tests/fixtures/moodle_logo.jpg" file to "Files" filemanager
    And I click on "Save changes" "button"
    And I am on the "bayesian 1 > student1 > Attempt 1" "mod_bayesian > Attempt review" page
    And I follow "Make comment or override mark"
    And I switch to "commentquestion" window
