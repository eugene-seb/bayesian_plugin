@mod @mod_bayesian
Feature: bayesian question versioning
  In order to manage question versions
  As a teacher
  I need to be able to choose which versions can be displayed in a bayesian
  ...
  Scenario: Appropriate question version should be displayed when not edited
    When I am on the "bayesian 1" "mod_bayesian > Edit" page logged in as "teacher"
  ...
  Scenario: Appropriate question version displayed when later draft version exists
    ...
    And I am on the "bayesian 1" "mod_bayesian > View" page
  ...
  Scenario: Creating a new question should have always latest in the version selection
    ...
    And I set the following fields to these values:
      ...
      | Question text   | Write 200 words about bayesianzes. |
    And I press "id_submitbutton"
    And I should see "New essay" on bayesian page "1"
  ...
  Scenario: Adding a question from question bank should have always latest in the version selection
    ...
    Then I should see "Other question" on bayesian page "1"
