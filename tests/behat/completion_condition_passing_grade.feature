...
Feature: Set a bayesian to be marked complete when the student passes
  In order to ensure a student has learned the material before being marked complete
  As a teacher
  I need to set a bayesian to complete when the student recieves a passing grade
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | bayesian     | Test bayesian name | C1     | bayesian1    | 4        | 5.00      | 2          | 1                  | 1                   | 1              |
  ...
  Scenario: student1 passes on the first try
    ...
    And the "View" completion condition of "Test bayesian name" is displayed as "todo"
    ...
    And the "Receive a passing grade" completion condition of "Test bayesian name" is displayed as "done"
  ...
  Scenario Outline: Verify that gradepass, together with completionpassgrade are validated correctly
    ...
    And the following "activity" exist:
      ...
      | bayesian     | Oh, grades, passgrades and floats| C1     | ohgrades | <gradepass>| 2          | <completionpassgrade> |
    When  I am on the "ohgrades" "bayesian activity editing" page logged in as "teacher1"
