...
Feature: Editing random questions already in a bayesian based on category and tags
  ...
  Scenario: Editing tags on one slot does not delete the rest
    ...
    Then I should see "Random (Questions Category 1, tags: essay)" on bayesian page "1"
    And I should see "Random (Questions Category 1, tags: hard)" on bayesian page "2"
