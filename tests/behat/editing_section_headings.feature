@mod @mod_bayesian
Feature: Edit bayesian page - section headings
  In order to build a bayesian laid out in sections the way I want
  As a teacher
  ...
  @javascript
  Scenario: We have a bayesian with one default section
  ...
  Scenario: Modify the default section headings
    Given the following "activities" exist:
      ...
      | bayesian       | bayesian 1 | bayesian 1 description | C1     | bayesian1    |
    When I am on the "bayesian 1" "mod_bayesian > Edit" page
    And I change bayesian section heading "" to "This is section one"
  ...
  Scenario: Modify section headings
    ...
    When I am on the "bayesian 1" "mod_bayesian > Edit" page
    And I change bayesian section heading "" to "This is section one"
    And I change bayesian section heading "Heading 2" to "This is section two"
    Then I should see "This is section one"
  ...
  Scenario: Set section headings to blanks
    ...
    When I change bayesian section heading "Heading 1" to ""
    Then I should not see "Heading 1"
    And I should see "Heading 2"
    And I should see "Heading 3"

    And I change bayesian section heading "Heading 2" to ""
    And I should not see "Heading 1"
    And I should not see "Heading 2"
    And I should see "Heading 3"

    And I change bayesian section heading "Heading 3" to ""
    And I should not see "Heading 1"
    And I should not see "Heading 2"
  ...
  Scenario: The edit-icon tool-tips are updated when a section is edited
    ...
    And bayesian "bayesian 1" contains the following sections:
      ...
      | Heading 2 | 2         | 0       |
    When I am on the "bayesian 1" "mod_bayesian > Edit" page
    And I change bayesian section heading "Heading 2" to "Edited heading"
  ...
  Scenario: Moving a question up from section 3 to the first section.
    ...
    And bayesian "bayesian 1" contains the following sections:
      ...
      | Heading 3 | 5         | 1       |
    When I am on the "bayesian 1" "mod_bayesian > Edit" page
    And I move "TF5" to "After Question 2" in the bayesian by clicking the move icon
    Then I should see "TF5" on bayesian page "2"
  ...
  Scenario: moving a question down from the first section to the second section.
    ...
    And bayesian "bayesian 1" contains the following sections:
      ...
      | Heading 3 | 5         | 1       |
    When I am on the "bayesian 1" "mod_bayesian > Edit" page
    And I move "TF1" to "After Question 3" in the bayesian by clicking the move icon
    Then I should see "TF1" on bayesian page "2"

  @javascript
  Scenario: I should not see a delete icon for the first section in the bayesian.
    Given the following "activities" exist:
      | activity   | name   | intro              | course | idnumber |
      | bayesian       | bayesian 1 | bayesian 1 description | C1     | bayesian1    |
    And the following "questions" exist:
  ...
  Scenario: Turn shuffling on for a section
    ...
    And bayesian "bayesian 1" contains the following sections:
      ...
      | Heading 3 | 3         | 0       |
    When I am on the "bayesian 1" "mod_bayesian > Edit" page
    And I click on shuffle for section "Heading 1" on the bayesian edit page
    And I click on shuffle for section "Heading 2" on the bayesian edit page
    Then shuffle for section "Heading 1" should be "On" on the bayesian edit page
    And shuffle for section "Heading 2" should be "On" on the bayesian edit page
  ...
  Scenario: Turn shuffling off for a section
    ...
    And I click on shuffle for section "Heading 1" on the bayesian edit page
    And I click on shuffle for section "Heading 2" on the bayesian edit page
    Then shuffle for section "Heading 1" should be "Off" on the bayesian edit page
    And shuffle for section "Heading 2" should be "Off" on the bayesian edit page
    And I reload the page
    And shuffle for section "Heading 1" should be "Off" on the bayesian edit page
    And shuffle for section "Heading 2" should be "Off" on the bayesian edit page
  ...
  Scenario: Verify sections are added in the right place afte ajax changes
    ...
    And I open the "Page 2" add to bayesian menu
  ...
  Scenario: Add section works after removing a page break with more than 10 pages
    ...
    And I open the "Page 10" add to bayesian menu
    And I choose "a new section heading" in the open action menu
