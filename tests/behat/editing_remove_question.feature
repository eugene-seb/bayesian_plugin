@mod @mod_bayesian
Feature: Edit bayesian page - remove questions
  ...
  Scenario: Delete questions by clicking on the delete icon.
    ...
    When I delete "Question C" in the bayesian by clicking the delete icon
    Then I should see "Question A" on bayesian page "1"
    And I should see "Question B" on bayesian page "1"
    ...
    Then I should see "Question B" on bayesian page "2"
    And the "Remove" page break icon after question "Question A" should exist
    And I delete "Question A" in the bayesian by clicking the delete icon
    Then I should see "Question B" on bayesian page "1"
    And I should not see "Page 2"
    And I should not see "Question A" on bayesian page "2"
  ...
  Scenario: Can delete the last question in a bayesian.
    ...
    And bayesian "bayesian 1" contains the following questions:
      ...
      | Question A | 1    |
    And I am on the "bayesian 1" "mod_bayesian > Edit" page
    When I delete "Question A" in the bayesian by clicking the delete icon
