@mod @mod_bayesian
Feature: Edit bayesian page - pagination
  In order to build a bayesian laid out in pages the way I want
  As a teacher
  ...
  Scenario: Repaginate questions with N question(s) per page as well as clicking
    ...
    Then I should see "Essay 01 new" on bayesian page "1"
    ...
    And I should see "Essay 02 new" on bayesian page "2"
    ...
    And I should see "Essay 01 new" on bayesian page "1"
    And I should see "Essay 02 new" on bayesian page "2"
    And I should see "Essay 03 new" on bayesian page "3"
    ...
    When I open the "Page 3" add to bayesian menu
    ...
    And I should see "Essay 02 new" on bayesian page "2"
    And I should see "Essay 03 new" on bayesian page "3"
    And I should see "Essay 04 new" on bayesian page "3"

    When I click on the "Add" page break icon after question "Essay 03 new"
    And I should see "Essay 01 new" on bayesian page "1"
    And I should see "Essay 02 new" on bayesian page "2"
    And I should see "Essay 03 new" on bayesian page "3"
    And I should see "Essay 04 new" on bayesian page "4"
