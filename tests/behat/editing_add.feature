@mod @mod_bayesian
Feature: Edit bayesian page - adding things
  In order to build the bayesian I want my students to attempt
  As a teacher
  I need to be able to add questions to the bayesian.
  ...
  @javascript
  Scenario: Add some new question to the bayesian using '+ a new question' options of the 'Add' menu.
    ...
    And I should see "Essay 01 new" on bayesian page "1"

    And I open the "Page 1" add to bayesian menu
    And I follow "a new question"
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    And I press "id_submitbutton"
    And I should see "Essay 01 new" on bayesian page "1"
    And I should see "Essay 02 new" on bayesian page "1"
    ...
    And I should see "Essay 01 new" on bayesian page "1"
    And I should see "Essay 02 new" on bayesian page "1"
    And I should see "Essay 03 new" on bayesian page "1"
    ...
    And I should see "Essay 02 new" on bayesian page "1"
    And I should see "Essay 03 new" on bayesian page "1"
    And I should see "Essay 04 new" on bayesian page "1"
    ...
    And I should see "Essay 01 new" on bayesian page "1"
    And I should see "Essay 02 new" on bayesian page "1"
    And I should see "Essay 03 new" on bayesian page "2"
    And I should see "Essay 04 new" on bayesian page "2"
    ...
    And I should see "Essay 03 new" on bayesian page "2"
    And I should see "Essay 04 new" on bayesian page "2"
    And I should see "Essay for page 2" on bayesian page "2"

  @javascript
  Scenario: Add questions from question bank to the bayesian. In order to be able to
      add questions from question bank to the bayesian, first we create some new questions
    ...
    Then the "Add selected questions to the bayesian" "button" should be disabled
    And I click on "Select" "checkbox" in the "Essay 03" "table_row"
    Then the "Add selected questions to the bayesian" "button" should be enabled
    And I click on "Add to bayesian" "link" in the "Essay 03" "table_row"
    And I should see "Essay 03" on bayesian page "1"

    # Add Essay 01 from question bank.
    And I open the "Page 1" add to bayesian menu
    And I follow "from question bank"
    And I click on "Add to bayesian" "link" in the "Essay 01" "table_row"
    And I should see "Essay 03" on bayesian page "1"
    And I should see "Essay 01" on bayesian page "1"
    ...
    And I should see "Select a category"
    And I set the field "Select a category" to "Subcat 1"
    And I click on "Add to bayesian" "link" in the "Essay 02" "table_row"
    And I should see "Essay 03" on bayesian page "1"
    And I should see "Essay 01" on bayesian page "1"
    And I should see "Essay 02" on bayesian page "1"
    ...
    And I should see "Essay 01" on bayesian page "1"
    And I should see "Essay 02" on bayesian page "1"
    And I should see "Random" on bayesian page "1"
    ...
    And I should see "Essay 03" on bayesian page "1"
    And I should see "Essay 01" on bayesian page "2"
    And I should see "Essay 02" on bayesian page "3"
    And I should see "Random" on bayesian page "4"

    # Add a random question to page 4.
    And I open the "Page 4" add to bayesian menu
    And I choose "a new question" in the open action menu
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    And I should see "Essay 02" on bayesian page "3"
    And I should see "Random" on bayesian page "4"
    And I should see "Essay for page 4" on bayesian page "4"
