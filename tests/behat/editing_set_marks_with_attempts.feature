@mod @mod_bayesian
Feature: Edit bayesian marks with attempts
  In order to create a bayesian that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit bayesian page (even after the bayesian has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | bayesian       | bayesian 1 | C1     | bayesian1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I add a "True/False" question to the "bayesian 1" bayesian with:
    ...
    And I add a "True/False" question to the "bayesian 1" bayesian with:
      ...
      | Default mark  | 3.0             |
    And I log out
    And I am on the "bayesian 1" "mod_bayesian > View" page logged in as "student1"
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the bayesian settings say it should be.
    ...
    When I am on the "bayesian 1" "bayesian activity editing" page
