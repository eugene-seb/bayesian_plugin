...
Feature: View activity completion in the bayesian activity
  In order to have visibility of bayesian completion requirements
  As a student
  I need to be able to view my bayesian completion progress
  ...
  Scenario Outline: View automatic completion items as a student
    ...
    And the "View" completion condition of "Test bayesian name" is displayed as "done"
    And the "Make attempts: 1" completion condition of "Test bayesian name" is displayed as "todo"
    ...
    And I follow "Test bayesian name"
    And the "View" completion condition of "Test bayesian name" is displayed as "done"
    And the "Make attempts: 1" completion condition of "Test bayesian name" is displayed as "done"
