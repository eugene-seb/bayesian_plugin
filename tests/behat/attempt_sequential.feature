@mod @mod_bayesian
Feature: Attempt a bayesian in a sequential mode
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | bayesian     | bayesian 1 | bayesian 1 description | C1     | bayesian1    | immediatefeedback  | sequential |
  ...
  Scenario Outline: As a student I should not be able to navigate out of sequence if sequential navigation is on.
    ...
    When I am on the "bayesian 1 > student > Attempt 1 > <pagenumber>" "mod_bayesian > Attempt view" page
  ...
  @javascript
  Scenario: As a student I should not be able to navigate out of sequence by opening new windows on the same bayesian.
    Given the following config values are set as admin:
      | config         | value | plugin |
      | autosaveperiod | 60    | bayesian   |
    And I am on the "bayesian 1" "mod_bayesian > View" page logged in as "student"
    And I press "Attempt bayesian"
    And I should see "First question"
    And I click on "True" "radio" in the "First question" "question"
    And I click on "Next page" "button"
    When I am on the "bayesian 1 > student > Attempt 1 > 3" "mod_bayesian > Attempt view" page
    And I click on "True" "radio" in the "Third question" "question"
    And I should see "Third question"
    And I click on "Next page" "button"
    And I am on the "bayesian 1 > student > Attempt 1 > 1" "mod_bayesian > Attempt view" page
  ...
  Scenario: As a student I should not be able to save my data by opening a given page out of sequence.
    Given the following config values are set as admin:
      | config         | value | plugin |
      | autosaveperiod | 1     | bayesian   |
    When I am on the "bayesian 1" "mod_bayesian > View" page logged in as "student"
    And I press "Attempt bayesian"
    And I am on the "bayesian 1 > student > Attempt 1 > 2" "mod_bayesian > Attempt view" page
  ...
  Scenario: As a student I can review question I have finished in any order
    ...
    When I am on the "bayesian 1" "mod_bayesian > View" page logged in as "student"
    And I follow "Review"
    And I am on the "bayesian 1 > student > Attempt 1 > 3" "mod_bayesian > Attempt view" page
    And I should see "Third question"
    And I am on the "bayesian 1 > student > Attempt 1 > 2" "mod_bayesian > Attempt view" page
    Then I should see "Second question"
