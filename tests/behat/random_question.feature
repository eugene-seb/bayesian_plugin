...
Feature: Moving a question to another category should not affect random questions in a bayesian
  In order for a bayesian with random questions to work as expected
  Teachers should be able to
  Move a question to a different category without affecting the category the random questions in the bayesian reference to
  ...
  Scenario: Moving a question should not change the random question
    ...
    And I should see "Random (Used category)" on bayesian page "1"
  ...
  Scenario: Renaming a random question category should update the random question
    ...
    And I am on the "bayesian 1" "mod_bayesian > Edit" page
    And I should see "Random (Used category new)" on bayesian page "1"
