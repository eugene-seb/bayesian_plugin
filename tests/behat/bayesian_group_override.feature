@mod @mod_bayesian
Feature: bayesian group override
  In order to grant a group special access to a bayesian
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | bayesian     | Test bayesian | Test bayesian description | C1     | bayesian1    | 1         |

  Scenario: Override Group 1 as teacher of Group 1
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    When I am on the "Test bayesian" "mod_bayesian > Group overrides" page logged in as "teacher1"
  ...
  Scenario: Add button disabled if there are no groups
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    When I am on the "Test bayesian" "mod_bayesian > Group overrides" page logged in as "teacher3"
  ...
  Scenario: A teacher with accessallgroups permission should see all group overrides
    Given the following "mod_bayesian > group overrides" exist:
      ...
      | Test bayesian | G1    | 2        |
      | Test bayesian | G2    | 2        |
    When I am on the "Test bayesian" "mod_bayesian > View" page logged in as "teacher1"
  ...
  Scenario: A teacher without accessallgroups permission should only see the group overrides within his/her groups, when the activity's group mode is "separate groups"
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    And the following "mod_bayesian > group overrides" exist:
      | bayesian      | group | attempts |
      | Test bayesian | G1    | 2        |
      | Test bayesian | G2    | 2        |
    When I am on the "Test bayesian" "mod_bayesian > View" page logged in as "teacher1"
  ...
  Scenario: A non-editing teacher can see the overrides, but not change them
    Given the following "mod_bayesian > group overrides" exist:
      ...
      | Test bayesian | G1    | 2        |
      | Test bayesian | G2    | 2        |
    When I am on the "Test bayesian" "mod_bayesian > Group overrides" page logged in as "helper"
    Then "Group 1" "table_row" should exist
    And "Group 2" "table_row" should exist
