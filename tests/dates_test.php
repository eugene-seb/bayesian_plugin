...
/**
 * Contains unit tests for mod_bayesian\dates.
 *
...
/**
 * Class for unit testing mod_bayesian\dates.
 *
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dates_test extends advanced_testcase {
     ...
     * @param int|null $timeopen Time of opening the bayesian.
     * @param int|null $timeclose Time of closing the bayesian.
     * @param int|null $usertimeopen The user override for opening the bayesian.
     * @param int|null $usertimeclose The user override for closing the bayesian.
     * @param int|null $grouptimeopen The group override for opening the bayesian.
     * @param int|null $grouptimeclose The group override for closing the bayesian.
