...
/**
 * Unit tests for the bayesian's own question bank view class.
 *
 ...
 */
class bayesian_question_bank_view_test extends \advanced_testcase {
    ...
    public function test_viewing_question_bank_should_not_load_individual_questions() {
        ...
        // Generate the view.
        $view = new custom_view($contexts, new \moodle_url('/'), $course, $cm, $bayesian);
        ob_start();
        $pagevars = [
            'qpage' => 0,
            'qperpage' => 20,
