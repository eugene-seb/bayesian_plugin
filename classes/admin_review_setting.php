...
/**
 * Admin settings class for the bayesian review options.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_bayesian_admin_review_setting extends admin_setting {
    /**
     * @var integer should match the constants defined in
     * {@link mod_bayesian_display_options}. Copied for performance reasons.
     */
    ...
    /**
     * This should match {@link mod_bayesian_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt'          => get_string('theattempt', 'bayesian'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'bayesian'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING            => get_string('reviewduring', 'bayesian'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'bayesian'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'bayesian'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'bayesian'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'bayesian'), $query);
    }
}
