...
/**
 * Cache data source for the bayesian overrides.
 *
...
namespace mod_bayesian\cache;

use cache_definition;

/**
 * Class bayesian_overrides
 *
 * @package   mod_bayesian
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class overrides implements \cache_data_source {
    ...
    public function load_for_cache($key) {
        ...
        [$bayesianid, $ug, $ugid] = explode('_', $key);
        $bayesianid = (int) $bayesianid;
        ...
        switch ($ug) {
            case 'u':
                ...
                $override = $DB->get_record(
                    'bayesian_overrides',
                    ['bayesian' => $bayesianid, 'userid' => $userid],
            ...
            case 'g':
                ...
                $override = $DB->get_record(
                    'bayesian_overrides',
                    ['bayesian' => $bayesianid, 'groupid' => $groupid],
                    'timeopen, timeclose, timelimit, attempts, password'
                );
                break;
            default:
