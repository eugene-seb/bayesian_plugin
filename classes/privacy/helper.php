...
/**
 * Privacy Subsystem helper for mod_bayesian.
 *
...
class helper {
    /**
     * Determine the subcontext for the specified bayesian attempt.
     *
     * @param   \stdClass       $attempt    The attempt data retrieved from the database.
     * @param   \stdClass       $user       The user record.
     * @return  \array                      The calculated subcontext.
     */
    public static function get_bayesian_attempt_subcontext(\stdClass $attempt, \stdClass $user) {
        $subcontext = [
