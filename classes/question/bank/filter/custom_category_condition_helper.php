...
namespace mod_bayesian\question\bank\filter;

use core_question\local\bank\question_version_status;

/**
 * A custom filter condition helper for bayesian to select question categories.
 *
 * This is required as bayesian will only use ready questions and the count should show according to that.
 *
