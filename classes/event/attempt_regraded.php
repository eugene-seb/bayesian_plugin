...
/**
 * The mod_bayesian attempt regraded event.
 *
...
/**
 * The mod_bayesian attempt regraded event class.
 *
...
class attempt_regraded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventbayesianattemptregraded', 'mod_bayesian');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' regraded bayesian attempt with id '$this->objectid' by user " .
