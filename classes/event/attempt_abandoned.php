...
/**
 * The mod_bayesian attempt abandoned event.
 *
...
/**
 * The mod_bayesian attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int bayesianid: (optional) id of the bayesian.
 * }
 *
 * @package    mod_bayesian
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the bayesian with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventbayesianattemptabandoned', 'mod_bayesian');
    }
    ...
    static public function get_legacy_eventname() {
        return 'bayesian_attempt_abandoned';
    }
