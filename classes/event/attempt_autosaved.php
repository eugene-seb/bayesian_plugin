...
/**
 * The mod_bayesian attempt auto-saved event.
 *
...
/**
 * The mod_bayesian attempt auto-saved event class.
 *
...
class attempt_autosaved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptautosaved', 'mod_bayesian');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' is working on page " .
            ...
            "with id '$this->objectid' for the bayesian with course module id '$this->contextinstanceid', " .
