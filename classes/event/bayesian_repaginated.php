...
/**
 * The mod_bayesian bayesian re-paginated event.
 *
...
/**
 * The mod_bayesian bayesian re-paginated event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bayesian_repaginated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventbayesianrepaginated', 'mod_bayesian');
    }

    public function get_description() {
        return "The user with id '$this->userid' re-paginated the bayesian with course module id '$this->contextinstanceid' " .
    ...
    public static function get_objectid_mapping() {
        return ['db' => 'bayesian', 'restore' => 'bayesian'];
    }
