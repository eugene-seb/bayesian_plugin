...
/**
 * The mod_bayesian slots moved event.
 *
...
/**
 * The mod_bayesian slot moved event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int bayesianid: the id of the bayesian.
 *      - int previousslotnumber: the previous slot number in bayesian.
 *      - int afterslotnumber: the new slot number in bayesian.
 *      - int page: the page of new slot position in bayesian.
 * }
 *
 * @package    mod_bayesian
 * @copyright  2021 The Open University
...
class slot_moved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventslotmoved', 'mod_bayesian');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has moved the slot with id '{$this->objectid}' " .
            ...
            "on page '{$this->other['page']}' belonging to the bayesian with course module id '$this->contextinstanceid'.";
    }
