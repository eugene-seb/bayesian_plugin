...
/**
 * The mod_bayesian attempt reviewed event.
 *
...
/**
 * The mod_bayesian attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_bayesian');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'bayesian', 'review', 'review.php?attempt=' . $this->objectid,
