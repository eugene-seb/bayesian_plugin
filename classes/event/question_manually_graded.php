...
/**
 * The mod_bayesian question manually graded event.
 *
 * @package    core
...
/**
 * The mod_bayesian question manually graded event class.
 *
...
class question_manually_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquestionmanuallygraded', 'mod_bayesian');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' manually graded the question with id '$this->objectid' for the attempt " .
            "with id '{$this->other['attemptid']}' for the bayesian with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/bayesian/comment.php', array('attempt' => $this->other['attemptid'],
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'bayesian', 'manualgrade', 'comment.php?attempt=' . $this->other['attemptid'] .
            '&slot=' . $this->other['slot'], $this->other['bayesianid'], $this->contextinstanceid);
    }
    ...
    public static function get_other_mapping() {
        ...
        $othermapped['attemptid'] = array('db' => 'bayesian_attempts', 'restore' => 'bayesian_attempt');
