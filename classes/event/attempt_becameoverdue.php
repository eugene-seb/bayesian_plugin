...
/**
 * The mod_bayesian attempt became overdue event.
 *
...
/**
 * The mod_bayesian attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The bayesian attempt with id '$this->objectid' belonging to the bayesian with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventbayesianattempttimelimitexceeded', 'mod_bayesian');
    }
    ...
    static public function get_legacy_eventname() {
        return 'bayesian_attempt_overdue';
    }
