...
/**
 * Cognitive depth indicator - bayesian.
 *
...
namespace mod_bayesian\analytics\indicator;
...
class cognitive_depth extends activity_base {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('indicator:cognitivedepth', 'mod_bayesian');
    }
    ...
    protected function feedback_submitted_events() {
        return array('\mod_bayesian\event\attempt_submitted');
    }
