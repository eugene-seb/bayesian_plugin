...
$baseurl = new moodle_url('/mod/bayesian/reviewquestion.php',
...
$PAGE->set_title(get_string('reviewofquestion', 'bayesian', array(
...
if ($attemptobj->is_own_attempt()) {
    if (!$attemptobj->is_finished()) {
        echo $output->review_question_not_allowed($attemptobj, get_string('cannotreviewopen', 'bayesian'));
        die();
...
// Other attempts at the bayesian.
