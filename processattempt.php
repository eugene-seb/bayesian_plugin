...
/**
 * This page deals with processing responses during an attempt at a bayesian.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_bayesian_exception($attemptobj->get_bayesianobj(),
...
if ($status == bayesian_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == bayesian_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
