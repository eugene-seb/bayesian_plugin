...
/**
 * A javascript module to handle submission confirmation for bayesian.
 *
 * @module    mod_bayesian/submission_confirmation
...
const SELECTOR = {
    attemptSubmitButton: '.path-mod-bayesian .btn-finishattempt button',
    attemptSubmitForm: 'form#frm-finishattempt',
};

const TEMPLATES = {
    submissionConfirmation: 'mod_bayesian/submission_confirmation',
};
...
export const init = (unAnsweredQuestions) => {
    ...
    Prefetch.prefetchStrings('bayesian', ['submitallandfinish', 'submission_confirmation']);
