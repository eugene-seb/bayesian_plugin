...
/**
 * Render the question slot template for each question in the bayesian edit view.
 *
 * @module     mod_bayesian/question_slot
...
const setQuestionVersion = (slotId, newVersion) => fetchMany([{
    methodname: 'mod_bayesian_set_question_version',
    args: {
        slotid: slotId,
...
const registerEventListeners = () => {
    document.addEventListener('change', e => {
        if (!e.target.matches('[data-action="mod_bayesian-select_slot"][data-slot-id]')) {
            return;
        }
