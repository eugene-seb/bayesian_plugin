 ...
 *
 * @module     mod_bayesian/modal_bayesian_question_bank
...
function(
    ...
    var SELECTORS = {
        ADD_TO_bayesian_CONTAINER: 'td.addtobayesianaction',
        ANCHOR: 'a[href]',
     ...
     */
    var ModalbayesianQuestionBank = function(root) {
    ...
    ModalbayesianQuestionBank.TYPE = 'mod_bayesian-bayesian-question-bank';
    ModalbayesianQuestionBank.prototype = Object.create(Modal.prototype);
    ModalbayesianQuestionBank.prototype.constructor = ModalbayesianQuestionBank;
     ...
     * @param {int} id
     */
    ModalbayesianQuestionBank.prototype.setContextId = function(id) {
        this.contextId = id;
    };
     ...
     * @return {int}
     */
    ModalbayesianQuestionBank.prototype.getContextId = function() {
        return this.contextId;
    };

    /**
     * Set the id of the page that the question should be added to
     * when the user clicks the add to bayesian link.
     *
     * @method setAddOnPageId
     * @param {int} id
     */
    ModalbayesianQuestionBank.prototype.setAddOnPageId = function(id) {
        this.addOnPageId = id;
    };
     ...
     * @return {int}
     */
    ModalbayesianQuestionBank.prototype.getAddOnPageId = function() {
     ...
     * @return {void}
     */
    ModalbayesianQuestionBank.prototype.show = function() {
     ...
     */
    ModalbayesianQuestionBank.prototype.reloadBodyContent = function(queryString) {
        // Load the question bank fragment to be displayed in the modal.
        var promise = Fragment.loadFragment(
            'mod_bayesian',
            'bayesian_question_bank',
            this.getContextId(),
            {
     ...
     *
     * @method handleAddTobayesianEvent
     * @param {event} e A JavaScript event
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalbayesianQuestionBank.prototype.handleAddTobayesianEvent = function(e, anchorElement) {
     ...
     * @param {object} anchorElement The anchor element that was triggered
     */
    ModalbayesianQuestionBank.prototype.handlePreviewContainerEvent = function(e, anchorElement) {
        var popupOptions = [
            'height=600',
            'width=800',
            'top=0',
     ...
     * @param {event} e A JavaScript event
     */
    ModalbayesianQuestionBank.prototype.handleDisplayOptionFormEvent = function(e) {
     ...
     *      - The bayesian category select box
     ...
     */
    ModalbayesianQuestionBank.prototype.registerDisplayOptionListeners = function() {
        // Listen for changes to the display options form.
     ...
     */
    ModalbayesianQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('submit', SELECTORS.ADD_QUESTIONS_FORM, function(e) {
            // If the user clicks on the "Add selected questions to the bayesian" button to add some questions to the page
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to bayesian link.
            if (anchorElement.closest(SELECTORS.ADD_TO_bayesian_CONTAINER).length) {
                this.handleAddTobayesianEvent(e, anchorElement);
                return;
            }
    ...
    if (!registered) {
        ModalRegistry.register(
            ModalbayesianQuestionBank.TYPE,
            ModalbayesianQuestionBank,
            'core/modal'
        );
    ...
    return ModalbayesianQuestionBank;
});
