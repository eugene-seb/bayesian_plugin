 ...
 *
 * This is also responsible for opening the pop-up window, if the bayesian requires to be in one.
 *
 * @module    mod_bayesian/preflightcheck
...
define(['jquery', 'core/yui', 'core_form/changechecker'], function($, Y, FormChangeChecker) {
    ...
    /**
     * @alias module:mod_bayesian/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the bayesian should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_bayesian_preflight_popup']
                    });
                ...
                if (popupoptions) {
                    Y.one(finalStartButton).on('click', t.launchbayesianPopup, t, popupoptions);
                }
            });
        },
        ...
        /**
         * Event handler for the bayesian start attempt button.
         * @param {Event} e the event being responded to
         * @param {Object} popupoptions
         */
        launchbayesianPopup: function(e, popupoptions) {
            e.halt();
