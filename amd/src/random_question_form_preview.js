 ...
 *
 * @module    mod_bayesian/random_question_form_preview
...
define(
    ...
    var TEMPLATE_NAME = 'mod_bayesian/random_question_form_preview_question_list';
    var SELECTORS = {
    ...
    var renderQuestionCount = function(root, questionCount) {
        Str.get_string('questionsmatchingfilter', 'mod_bayesian', questionCount)
