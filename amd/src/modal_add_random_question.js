 ...
 *
 * @module     mod_bayesian/modal_add_random_question
...
function(
    ...
    ModalAddRandomQuestion.TYPE = 'mod_bayesian-bayesian-add-random-question';
    ...
    if (!registered) {
        ModalRegistry.register(
            ...
            'mod_bayesian/modal_add_random_question'
        );
