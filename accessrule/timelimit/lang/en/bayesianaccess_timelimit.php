...
/**
 * Strings for the bayesianaccess_timelimit plugin.
 *
...
$string['pluginname'] = 'Time limit bayesian access rule';
$string['privacy:metadata'] = 'The Time limit bayesian access rule plugin does not store any personal data.';
$string['bayesiantimelimit'] = 'Time limit: {$a}';
