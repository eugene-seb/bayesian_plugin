...
/**
 * Base class for rules that restrict the ability to attempt a bayesian.
 *
...
/**
 * A base class that defines the interface for the various bayesian access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class bayesian_access_rule_base {
    /** @var stdClass the bayesian settings. */
    protected $bayesian;
    /** @var bayesian the bayesian object. */
     ...
     */
    public function __construct($bayesianobj, $timenow) {
        $this->bayesianobj = $bayesianobj;
        $this->bayesian = $bayesianobj->get_bayesian();
     ...
     *
     * @param mod_bayesian_preflight_check_form $bayesianform the form being built.
    ...
    /**
     * This is called when the current attempt at the bayesian is finished. This is
     ...
     * this bayesian, then return true. This is used so we can know whether to display a
    ...
    /**
     * @return array key => lang string any choices to add to the bayesian Browser
     ...
     */
    public static function get_settings_sql($bayesianid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($bayesianid) {
        return array();
    }
}
