...
/**
 * Manage the bayesian views.
 *
 * @module     bayesianaccess_seb/view
...
const TEMPLATE = {
    LOADING: 'bayesianaccess_seb/loading',
};
...
export const showValidationFailedModal = () => {
    ModalFactory.create({
        ...
        title: Str.get_string('sebkeysvalidationfailed', 'bayesianaccess_seb'),
        body: Str.get_string('invalidkeys', 'bayesianaccess_seb'),
        large: false,
    }).then((modal) => {
        modal.show();
