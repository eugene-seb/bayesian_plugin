...
class link_generator_test extends \advanced_testcase {
    ...
    public function test_http_link_generated() {
        ...
        $bayesian = $this->getDataGenerator()->create_module('bayesian', ['course' => $course->id]);

        $this->assertEquals(
            "http://www.example.com/moodle/mod/bayesian/accessrule/seb/config.php?cmid=$bayesian->cmid",
            link_generator::get_link($bayesian->cmid, false, false));
    }
    ...
    public function test_https_link_generated() {
        ...
        $this->assertEquals(
            "https://www.example.com/moodle/mod/bayesian/accessrule/seb/config.php?cmid=$bayesian->cmid",
            link_generator::get_link($bayesian->cmid, false));
    }
    ...
    public function test_seb_link_generated() {
        ...
        $this->assertEquals(
            "seb://www.example.com/moodle/mod/bayesian/accessrule/seb/config.php?cmid=$bayesian->cmid",
            link_generator::get_link($bayesian->cmid, true, false));
    }
    ...
    public function test_sebs_link_generated() {
        ...
        $this->assertEquals(
            "sebs://www.example.com/moodle/mod/bayesian/accessrule/seb/config.php?cmid=$bayesian->cmid",
            link_generator::get_link($bayesian->cmid, true));
    }
