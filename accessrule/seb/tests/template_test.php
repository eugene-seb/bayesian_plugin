...
<plist version=\"1.0\"><dict><key>showTaskBar</key><true/><key>allowWlan</key><false/><key>showReloadButton</key><true/>"
    ...
    /**
     * Test that a template cannot be deleted when assigned to a bayesian.
     */
    public function test_cannot_delete_template_when_assigned_to_bayesian() {
        global $DB;
...
<plist version=\"1.0\"><dict><key>showTaskBar</key><true/><key>allowWlan</key><false/><key>showReloadButton</key><true/>"
        ...
        $DB->insert_record(bayesian_settings::TABLE, (object) [
            'bayesianid' => 1,
            'cmid' => 1,
