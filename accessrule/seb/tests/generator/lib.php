...
/**
 * Data generator the bayesianaccess_seb plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bayesianaccess_seb_generator extends component_generator_base {
    ...
    public function create_template(array $data) {
        ...
        if (!isset($data['content'])) {
            $data['content'] = file_get_contents(
                $CFG->dirroot . '/mod/bayesian/accessrule/seb/tests/fixtures/unencrypted.seb'
            );
        }
