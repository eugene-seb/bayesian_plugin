...
class template_disabled extends base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'bayesianaccess_seb_template';
        $this->data['crud'] = 'u';
    ...
    public static function get_name() {
        return get_string('event:templatedisabled', 'bayesianaccess_seb');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/bayesian/accessrule/seb/template.php', $params);
    }
    ...
    public static function get_objectid_mapping() : array {
        return array('db' => 'bayesianaccess_seb_template', 'restore' => 'bayesianaccess_seb_template');
    }
