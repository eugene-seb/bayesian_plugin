...
/**
 * Event for when access to a bayesian is prevented by this subplugin.
 *
...
class access_prevented extends base {
    ...
    public static function create_strict(access_manager $accessmanager, string $reason,
        ...
        return self::create([
            'userid' => $USER->id,
            'objectid' => $accessmanager->get_bayesian()->get_bayesianid(),
            'courseid' => $accessmanager->get_bayesian()->get_courseid(),
            'context' => $accessmanager->get_bayesian()->get_context(),
            'other' => $other,
        ]);
    }
    ...
    protected function init() {
        $this->data['objecttable'] = 'bayesian';
        $this->data['crud'] = 'r';
    ...
    public static function get_name() {
        return get_string('event:accessprevented', 'bayesianaccess_seb');
    }
    ...
    public function get_description() {
        $description = "The user with id '$this->userid' has been prevented from accessing bayesian with id '$this->objectid' by the "
    ...
    public static function get_objectid_mapping() : array {
        return array('db' => 'bayesian', 'restore' => 'bayesian');
    }
