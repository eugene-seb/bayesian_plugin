...
namespace bayesianaccess_seb\local\table;

use bayesianaccess_seb\helper;
use bayesianaccess_seb\template;
use bayesianaccess_seb\template_controller;
...
class template_list extends \flexible_table {
    ...
    public function __construct($id = null) {
        ...
        parent::__construct('bayesianaccess_seb' . $id);
        ...
        $this->define_headers([
            get_string('name', 'bayesianaccess_seb'),
            get_string('description', 'bayesianaccess_seb'),
            get_string('enabled', 'bayesianaccess_seb'),
            get_string('used', 'bayesianaccess_seb'),
            get_string('actions'),
        ]);
     ...
     * Display name column.
     *
     * @param \bayesianaccess_seb\template $data Template for this row.
     * @return string
     */
     ...
     *
     * @param \bayesianaccess_seb\template[] $records An array with records.
     */
