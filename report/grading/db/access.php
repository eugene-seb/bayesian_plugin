...
/**
 * Capability definitions for the bayesian manual grading report.
 *
...
$capabilities = array(
    ...
    'bayesian/grading:viewstudentnames' => array(
        'captype' => 'read',
        ...
        'clonepermissionsfrom' => 'mod/bayesian:viewreports'
    ),
    ...
    'bayesian/grading:viewidnumber' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'legacy' => array(
            'teacher' => CAP_ALLOW,
