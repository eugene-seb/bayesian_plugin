...
use bayesian_grading\privacy\provider;
...
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_preference_bool_true() {
        ...
        set_user_preference('bayesian_grading_pagesize', 42);
        set_user_preference('bayesian_grading_order', 'random');
        ...
        $preferences = $writer->get_user_preferences('bayesian_grading');
    ...
    public function test_preference_bool_true_for_user_customfields() {
        ...
        foreach ($customfields as $customfield) {
            set_user_preference('bayesian_grading_order', $customfield);
