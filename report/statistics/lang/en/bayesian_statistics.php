...
/**
 * Strings for component 'bayesian_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['backtobayesianreport'] = 'Back to main statistics report page.';
$string['calculatefrom'] = 'Calculate statistics from';
$string['calculatingallstats'] = 'Calculating statistics for bayesian, questions and analysing response data';
...
$string['errorpowers'] = 'Error fetching data to calculate variance for bayesian grades';
...
$string['negcovar_help'] = 'This question\'s grade for this set of attempts on the bayesian varies in an opposite way to the overall attempt grade. This means overall attempt grade tends to be below average when the grade for this question is above average and vice-versa.

Our equation for effective question weight cannot be calculated in this case. The calculations for effective question weight for other questions in this bayesian are the effective question weight for these questions if the highlighted questions with a negative covariance are given a maximum grade of zero.

If you edit a bayesian and give these question(s) with negative covariance a max grade of zero then the effective question weight of these questions will be zero and the real effective question weight of other questions will be as calculated now.';
$string['nogradedattempts'] = 'No attempts have been made at this bayesian, or all attempts have questions that need manual grading.';
...
$string['privacy:metadata'] = 'Although the bayesian Statistics plugin has database tables, the data is aggregate data and does not describe a unique indidividual.';
...
$string['bayesianinformation'] = 'bayesian information';
$string['bayesianname'] = 'bayesian name';
$string['bayesianoverallstatistics'] = 'bayesian overall statistics';
$string['bayesianstructureanalysis'] = 'bayesian structure analysis';
...
$string['statsfor'] = 'bayesian statistics (for {$a})';
