...
/**
 * Standard plugin entry points of the bayesian statistics report.
 *
 ...
 * @package  bayesian_statistics
 * @category files
 * @param context $previewcontext the bayesian context
 ...
 */
function bayesian_statistics_question_preview_pluginfile($previewcontext, $questionid,
    ...
    require_capability('bayesian/statistics:view', $context);
