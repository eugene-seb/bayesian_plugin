@mod @mod_bayesian @bayesian @bayesian_statistics
Feature: Basic use of the Statistics report
  ...
  Scenario: Report works when there are no attempts
    When I am on the "bayesian 1" "mod_bayesian > Statistics report" page logged in as teacher1
    Then I should see "No attempts have been made at this bayesian, or all attempts have questions that need manual grading."
    ...
    And user "student2" has attempted "bayesian 1" with responses:
      ...
      |   2  | True     |
      |   3  | True     |
    And user "student3" has attempted "bayesian 1" with responses:
      | slot | response |
      |   1  | False    |
      |   2  | False    |
      |   3  | False    |
    And I am on the "bayesian 1" "mod_bayesian > Statistics report" page logged in as teacher1
