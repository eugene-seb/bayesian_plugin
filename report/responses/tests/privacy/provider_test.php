...
use bayesian_responses\privacy\provider;
...
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_preference_bool_true() {
        ...
        set_user_preference('bayesian_report_responses_qtext', true);
        set_user_preference('bayesian_report_responses_resp', true);
        set_user_preference('bayesian_report_responses_right', true);
        ...
        $preferences = $writer->get_user_preferences('bayesian_responses');
    ...
    public function test_preference_bool_false() {
        ...
        set_user_preference('bayesian_report_responses_qtext', false);
        set_user_preference('bayesian_report_responses_resp', false);
        set_user_preference('bayesian_report_responses_right', false);
    ...
    public function test_preference_bool_which_first() {
        ...
        set_user_preference('bayesian_report_responses_which_tries', \question_attempt::FIRST_TRY);
        ...
        $expected = get_string("privacy:preference:which_tries:first", 'bayesian_responses');
