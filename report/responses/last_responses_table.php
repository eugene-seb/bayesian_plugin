...
/**
 * This file defines the bayesian responses table for showing last try at question.
 *
...
/**
 * This is a table subclass for displaying the bayesian responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bayesian_last_responses_table extends bayesian_attempts_report_table {
     ...
     * @param bayesian_responses_options $options
     * @param \core\dml\sql_join $groupstudentsjoins
     * @param \core\dml\sql_join $studentsjoins
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($bayesian, $context, $qmsubselect, bayesian_responses_options $options,
            \core\dml\sql_join $groupstudentsjoins, \core\dml\sql_join $studentsjoins, $questions, $reporturl) {
        parent::__construct('mod-bayesian-report-responses-report', $bayesian, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->bayesian->id . '&amp;attempt=' .
