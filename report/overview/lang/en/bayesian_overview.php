...
/**
 * Strings for component 'bayesian_overview', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['nogradepermission'] = 'You don\'t have permission to grade this bayesian.';
$string['onlyoneattemptallowed'] = 'Only one attempt per user allowed on this bayesian.';
$string['optallattempts'] = 'all attempts';
$string['optallstudents'] = 'all {$a} who have or have not attempted the bayesian';
$string['optattemptsonly'] = '{$a} who have attempted the bayesian';
$string['optnoattemptsonly'] = '{$a} who have not attempted the bayesian';
...
$string['privacy:metadata:preference:bayesian_overview_slotmarks'] = 'Whether to show marks for each question slot.';
...
$string['showinggradedandungraded'] = 'Showing graded and ungraded attempts for each user. The one attempt for each user that is graded is highlighted. The grading method for this bayesian is {$a}.';
