...
/**
 * Class to store the options for a {@link bayesian_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bayesian_overview_options extends mod_bayesian_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('bayesian_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (bayesian_has_grades($this->bayesian)) {
            set_user_preference('bayesian_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/bayesian:regrade', 'mod/bayesian:deleteattempts'), context_module::instance($this->cm->id))
