...
use bayesian_overview\privacy\provider;
...
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_preference_yes() {
        ...
        set_user_preference('bayesian_overview_slotmarks', 1, $user);
        ...
        $preferences = $writer->get_user_preferences('bayesian_overview');
    ...
    public function test_preference_no() {
        ...
        set_user_preference('bayesian_overview_slotmarks', 0);
