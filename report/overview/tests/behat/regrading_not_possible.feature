...
Feature: bayesian regrade when not possible
  ...
  Background:
    ...
    And the following "question categories" exist:
      ...
      | Activity module | bayesian1     | Test questions |
    ...
    And bayesian "bayesian for testing regrading" contains the following questions:
      ...
      | MC       | 1    | 10.0    |
    And user "student" has attempted "bayesian for testing regrading" with responses:
      | slot | response |
      |   1  | B        |
  ...
  Scenario: Try a regrade after the question has been edited to have a different number of choices
    ...
    When I am on the "bayesian for testing regrading" "mod_bayesian > grades report" page
