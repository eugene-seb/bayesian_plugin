@mod @mod_bayesian @bayesian @bayesian_overview
Feature: Basic use of the Grades report
  In order to easily get an overview of bayesian attempts
  As a teacher
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | description | Intro | Welcome to this bayesian |
  ...
  Scenario: Using the Grades report
    ...
    When I am on the "bayesian 1" "bayesian activity" page logged in as teacher1
    ...
    And I set the field "Attempts from" to "all users who have attempted the bayesian"
    And I press "Show report"
    # Check student1's grade
    And I should see "25.00" in the "S1 Student1" "table_row"
    # Check student2's grade
  ...
  Scenario: View custom user profile fields in the grades report
    ...
    And I am on the "bayesian 1" "bayesian activity" page logged in as teacher1
    And I navigate to "Results" in current page administration
