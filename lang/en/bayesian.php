...
/**
 * Strings for component 'bayesian', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['accessnoticesheader'] = 'You can preview this bayesian, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have bayesianzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the bayesian. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the bayesian. This means that different students are likely to get a different selection of questions, and when a bayesian allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any bayesian in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your bayesian over on the other side of this page.</p>';
...
$string['addquestionstobayesian'] = 'Add questions to current bayesian';
...
$string['addrandomquestiontobayesian'] = 'Add a random question to bayesian {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstobayesian'] = 'Add selected questions to the bayesian';
$string['addselectedtobayesian'] = 'Add selected to bayesian';
$string['addtobayesian'] = 'Add to bayesian';
...
$string['attempterror'] = 'You are not allowed to attempt this bayesian at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid bayesian attempt ID';
$string['attempterrorcontentchange'] = 'This bayesian preview no longer exists. (When a bayesian is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This bayesian attempt no longer exists.';
...
$string['attemptbayesiannow'] = 'Attempt bayesian now';
$string['attemptbayesian'] = 'Attempt bayesian';
...
$string['attemptsdeleted'] = 'bayesian attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during bayesian attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtobayesian'] = 'Back to bayesian editing';
...
* The bayesian will only start if the student has a JavaScript-enabled web-browser
* The bayesian appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this bayesian has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the bayesian';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this bayesian. The bayesian is set to be graded out of {$a->grade}, but none of the questions in the bayesian have a grade. This can be fixed on the \'Edit bayesian\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this bayesian. The bayesian definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this bayesian. The bayesian has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, after finishing attempting a question, a \'Try another question like this one\' button is displayed. This allows for a similar question (selected randomly) to be attempted, or the same question again, without the entire bayesian attempt having to be submitted and another attempt started. This option is useful for practice bayesianzes.
...
$string['closebeforeopen'] = 'Could not update the bayesian. You have specified a close date before the open date.';
...
$string['completionattemptsexhausted_help'] = 'Mark bayesian complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the bayesian.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the bayesian.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the bayesian.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a bayesian after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the bayesian.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new bayesian. You can also configure which bayesian settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the bayesian grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the bayesian page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the bayesian editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during bayesian attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the bayesian.';
$string['configrequiresubnet'] = 'Students can only attempt the bayesian from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a bayesian attempt or look at the bayesian reports.';
$string['configshowblocks'] = 'Show blocks during bayesian attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this bayesian, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for bayesianzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for bayesianzes in seconds. 0 mean no time limit.';
...
$string['continueattemptbayesian'] = 'Continue your attempt';
...
$string['countdownfinished'] = 'The bayesian is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The bayesian will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to bayesian';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the bayesian.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the bayesian a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the bayesian a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/bayesian folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new bayesian attempt will contain the results of the previous attempt. This allows a bayesian to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingbayesian'] = 'Editing bayesian';
$string['editingbayesian_help'] = 'When creating a bayesian, the main concepts are:

* The bayesian, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the bayesian and different students can get different questions';
$string['editingbayesian_link'] = 'mod/bayesian/edit';
$string['editingbayesianx'] = 'Editing bayesian: {$a}';
...
$string['editbayesian'] = 'Edit bayesian';
$string['editbayesianquestions'] = 'Edit bayesian questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->bayesianname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this bayesian at {$a->bayesianurl}.';
$string['emailconfirmbodyautosubmit'] = 'Hi {$a->username},

The time for the bayesian \'{$a->bayesianname}\' in the course \'{$a->coursename}\' expired. Your answers were submitted automatically at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this bayesian at {$a->bayesianurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->bayesianname}\'';
$string['emailconfirmautosubmitsmall'] = 'Thank you for submitting your answers to \'{$a->bayesianname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->bayesianname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->bayesianname}\' ({$a->bayesianurl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->bayesianreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->bayesianname}. See {$a->bayesianreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->bayesianname}';
$string['emailmanualgradedbody'] = 'Hi {$a->studentname},

Your answers to \'{$a->bayesianname}\' in course \'{$a->coursename}\' at {$a->attempttimefinish} have now been graded.

You will be able to view your score and feedback by visiting \'{$a->bayesianurl}\' and reviewing your attempt.';

$string['emailmanualgradedsubject'] = 'Your attempt at {$a->bayesianname} has been graded';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->bayesianname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->bayesianname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->bayesianname}';
$string['empty'] = 'Empty';
...
$string['eventattemptautosaved'] = 'bayesian attempt auto-saved';
$string['eventattemptdeleted'] = 'bayesian attempt deleted';
$string['eventattemptmanualgradingcomplete'] = 'bayesian attempt manual grading complete';
$string['eventattemptpreviewstarted'] = 'bayesian attempt preview started';
$string['eventattemptquestionrestarted'] = 'bayesian attempt question restarted';
$string['eventattemptreviewed'] = 'bayesian attempt reviewed';
$string['eventattemptsummaryviewed'] = 'bayesian attempt summary viewed';
$string['eventattemptupdated'] = 'bayesian attempt updated';
$string['eventattemptviewed'] = 'bayesian attempt viewed';
$string['eventeditpageviewed'] = 'bayesian edit page viewed';
$string['eventoverridecreated'] = 'bayesian override created';
$string['eventoverridedeleted'] = 'bayesian override deleted';
$string['eventoverrideupdated'] = 'bayesian override updated';
...
$string['eventbayesianattemptabandoned'] = 'bayesian attempt abandoned';
$string['eventbayesianattempttimelimitexceeded'] = 'bayesian attempt time limit exceeded';
$string['eventbayesianattemptregraded'] = 'bayesian attempt regraded';
$string['eventbayesianattemptstarted'] = 'bayesian attempt started';
$string['eventbayesianattemptsubmitted'] = 'bayesian attempt submitted';
$string['eventbayesiangradeupdated'] = 'bayesian grade updated';
$string['eventbayesianrepaginated'] = 'bayesian re-paginated';
$string['eventreportviewed'] = 'bayesian report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the bayesian. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the bayesian when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the bayesian. You have to make a trade-off based on how much you trust the performance of your server during bayesianzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final bayesian grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'bayesian grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->bayesiangrade}.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this bayesian has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt bayesianzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a bayesian.';
...
$string['indicator:cognitivedepth'] = 'bayesian cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a bayesian activity.';
$string['indicator:cognitivedepthdef'] = 'bayesian cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the bayesian activities during this analysis interval (Levels = No view, View, Submit, View feedback, Comment on feedback, Resubmit after viewing feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'bayesian social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a bayesian activity.';
$string['indicator:socialbreadthdef'] = 'bayesian social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the bayesian activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new bayesian, provide this many blank overall feedback boxes. Once the bayesian has been created, the form shows the number of fields required for the number of feedbacks in the bayesian. The setting must be at least 1.';
...
$string['invalidbayesianid'] = 'Invalid bayesian ID';
...
$string['legacybayesianaccessrulescron'] = 'Legacy cron bayesian access rules';
$string['legacybayesianreportscron'] = 'Legacy cron bayesian reports';
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in bayesian';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->bayesian} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your bayesian attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own bayesian submissions';
$string['messageprovider:attempt_grading_complete'] = 'Notification that your attempt has been graded';
$string['messageprovider:submission'] = 'Notification of your students\' bayesian submissions';
$string['max'] = 'Max';
...
$string['modulename'] = 'bayesian';
$string['modulename_help'] = 'The bayesian activity enables a teacher to create bayesianzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the bayesian to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/bayesian/view';
$string['modulenameplural'] = 'bayesianzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the bayesian in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the bayesian';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer bayesianzes it makes sense to stretch the bayesian over several pages by limiting the number of questions per page. When adding questions to the bayesian, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this bayesian';
...
$string['nogradewarning'] = 'This bayesian is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the bayesian settings.';
...
$string['noquestionsinbayesian'] = 'There are no questions in this bayesian.';
...
$string['noreview'] = 'You are not allowed to review this bayesian';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this bayesian until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This bayesian is currently not available to your students.';
...
$string['notifyattemptsgradedtask'] = 'Send bayesian attempt graded notifications';
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the bayesian module. As a work around, set a time limit for the whole bayesian. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this bayesian';
...
$string['openafterclose'] = 'Could not update the bayesian. You have specified an open date after the close date.';
$string['openclosedatesupdated'] = 'bayesian open and close dates updated';
...
$string['orderingbayesian'] = 'Order and paging';
$string['orderingbayesianx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a bayesian has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the bayesian before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if a student fails to submit their bayesian attempt before the time expires. If the student is actively working on the bayesian at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/bayesian/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this bayesian to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->bayesian} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overridesforbayesian'] = 'Settings overrides: {$a}';
$string['overridesnoneforgroups'] = 'No group settings overrides have been created for this bayesian.';
$string['overridesnoneforusers'] = 'No user settings overrides have been created for this bayesian.';
...
$string['overrideusereventname'] = '{$a->bayesian} - Override';
$string['pageshort'] = 'P';
$string['page-mod-bayesian-x'] = 'Any bayesian module page';
$string['page-mod-bayesian-attempt'] = 'Attempt bayesian page';
$string['page-mod-bayesian-edit'] = 'Edit bayesian page';
$string['page-mod-bayesian-report'] = 'Any bayesian report page';
$string['page-mod-bayesian-review'] = 'Review bayesian attempt page';
$string['page-mod-bayesian-summary'] = 'bayesian attempt summary page';
$string['page-mod-bayesian-view'] = 'bayesian information page';
...
$string['pluginadministration'] = 'bayesian administration';
$string['pluginname'] = 'bayesian';
$string['popup'] = 'Show bayesian in a \'secure\' window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the bayesian in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this bayesian in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewbayesian'] = 'Preview {$a}';
$string['previewbayesianstart'] = 'Preview bayesian';
$string['previewbayesiannow'] = 'Preview bayesian now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The bayesian activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:bayesian'] = 'The bayesian activity makes use of bayesian reports.';
$string['privacy:metadata:bayesian_attempts'] = 'Details about each attempt on a bayesian.';
$string['privacy:metadata:bayesian_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:bayesian_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:bayesian_attempts:gradednotificationsenttime'] = 'The time the user was notified that manual grading of their attempt was complete';
$string['privacy:metadata:bayesian_attempts:preview'] = 'Whether this is a preview of the bayesian.';
$string['privacy:metadata:bayesian_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:bayesian_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:bayesian_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:bayesian_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:bayesian_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:bayesian_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:bayesian_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:bayesian_grades'] = 'Details about the overall grade for this bayesian.';
$string['privacy:metadata:bayesian_grades:grade'] = 'The overall grade for this bayesian.';
$string['privacy:metadata:bayesian_grades:bayesian'] = 'The bayesian that was graded.';
$string['privacy:metadata:bayesian_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:bayesian_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:bayesian_overrides'] = 'Details about overrides for this bayesian';
$string['privacy:metadata:bayesian_overrides:bayesian'] = 'The bayesian with override information';
$string['privacy:metadata:bayesian_overrides:timeclose'] = 'The new close time for the bayesian.';
$string['privacy:metadata:bayesian_overrides:timelimit'] = 'The new time limit for the bayesian.';
$string['privacy:metadata:bayesian_overrides:timeopen'] = 'The new open time for the bayesian.';
$string['privacy:metadata:bayesian_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:bayesianaccess'] = 'The bayesian activity makes use of bayesian access rules.';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->bayesiannames}<br />The question will not be deleted from these bayesianzes but only from the category list.';
...
$string['questionsinthisbayesian'] = 'Questions in this bayesian';
...
$string['bayesian:addinstance'] = 'Add a new bayesian';
$string['bayesian:attempt'] = 'Attempt bayesianzes';
$string['bayesianavailable'] = 'The bayesian is available until: {$a}';
$string['bayesianclose'] = 'Close the bayesian';
$string['bayesianclosed'] = 'This bayesian closed on {$a}';
$string['bayesiancloses'] = 'bayesian closes';
$string['bayesianeventcloses'] = '{$a} closes';
$string['bayesiancloseson'] = 'This bayesian will close on {$a}.';
$string['bayesian:deleteattempts'] = 'Delete bayesian attempts';
$string['bayesian:emailconfirmsubmission'] = 'Receive confirmation of your own bayesian submissions';
$string['bayesian:emailnotifysubmission'] = 'Receive notification of your students\' bayesian submissions';
$string['bayesian:emailnotifyattemptgraded'] = 'Receive notification when your attempt has been graded';
$string['bayesian:emailwarnoverdue'] = 'Receive warning when your bayesian attempt becomes overdue';
$string['bayesian:grade'] = 'Grade bayesianzes manually';
$string['bayesian:ignoretimelimits'] = 'Ignore bayesian time limit';
$string['bayesianisclosed'] = 'This bayesian is closed';
$string['bayesianisopen'] = 'This bayesian is open';
$string['bayesianisclosedwillopen'] = 'bayesian closed (opens {$a})';
$string['bayesianisopenwillclose'] = 'bayesian open (closes {$a})';
$string['bayesian:manage'] = 'Manage bayesianzes';
$string['bayesian:manageoverrides'] = 'Manage bayesian settings overrides';
$string['bayesian:viewoverrides'] = 'View bayesian settings overrides';
$string['bayesiannavigation'] = 'bayesian navigation';
$string['bayesianopen'] = 'Open the bayesian';
$string['bayesianeventopens'] = '{$a} opens';
$string['bayesianopenclose'] = 'Open and close dates';
$string['bayesianopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['bayesianopenclose_link'] = 'mod/bayesian/timing';
$string['bayesianopened'] = 'This bayesian is open.';
$string['bayesianopenedon'] = 'This bayesian opened on {$a}';
$string['bayesianopens'] = 'bayesian opens';
$string['bayesianopenwillclose'] = 'This bayesian is open, will close on {$a} at';
$string['bayesianordernotrandom'] = 'Order of bayesian not shuffled';
$string['bayesianorderrandom'] = '* Order of bayesian is shuffled';
$string['bayesian:preview'] = 'Preview bayesianzes';
$string['bayesian:regrade'] = 'Regrade bayesian attempts';
$string['bayesianreport'] = 'bayesian report';
$string['bayesian:reviewmyattempts'] = 'Review your own attempts';
$string['bayesiansettings'] = 'bayesian settings';
$string['bayesian:view'] = 'View bayesian information';
$string['bayesian:viewreports'] = 'View bayesian reports';
$string['bayesiantimer'] = 'bayesian Timer';
$string['bayesianwillopen'] = 'This bayesian will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole bayesian to be graded.  Are you sure you want to continue?';
$string['reattemptbayesian'] = 'Re-attempt bayesian';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this bayesian';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingbayesian'] = 'Regrading bayesian "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallbayesianattempts'] = 'Delete all bayesian attempts';
...
$string['reportusersall'] = 'all users who have attempted the bayesian';
$string['reportuserswith'] = 'enrolled users who have attempted the bayesian';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the bayesian';
$string['reportuserswithout'] = 'enrolled users who have not attempted the bayesian';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the bayesian.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'bayesian access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) bayesian, to ensure that only people in a certain location can access the bayesian.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to bayesian defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after bayesian is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while bayesian is open';
$string['reviewclosed'] = 'After the bayesian is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->bayesian} by {$a->user}';
$string['reviewopen'] = 'Later, while the bayesian is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a bayesian attempt or look at the bayesian reports.
...
**Later, while the bayesian is still open** settings apply after this, and before the bayesian close date.

**After the bayesian is closed** settings apply after the bayesian close date has passed. If the bayesian does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current bayesian attempt.';
...
$string['savebayesian'] = 'Save this whole bayesian';
...
$string['search:activity'] = 'bayesian - activity information';
...
$string['showblocks'] = 'Show blocks during bayesian attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during bayesian attempts';
...
$string['shufflequestions_help'] = 'If enabled, every time the bayesian is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the bayesian, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonbayesian'] = 'Specified question is not on the specified bayesian';
...
$string['subneterror'] = 'Sorry, this bayesian has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this bayesian.';
$string['subnetnotice'] = 'This bayesian has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_bayesian'] = 'Report';
$string['subplugintype_bayesian_plural'] = 'Reports';
$string['subplugintype_bayesianaccess'] = 'Access rule';
$string['subplugintype_bayesianaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the bayesian.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the bayesian since you have not passed the time delay before attempting another bayesian';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial bayesian page and a countdown timer is displayed in the bayesian navigation block.';
$string['timelimit_link'] = 'mod/bayesian/timing';
$string['timelimitexeeded'] = 'Sorry! bayesian time limit exceeded!';
...
$string['updateoverdueattemptstask'] = 'Updating overdue bayesian attempts';
$string['updatesettings'] = 'Update bayesian settings';
$string['updatebayesianslotswithrandomxofy'] = 'Updating bayesian slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the bayesian module will perform an extensive change of the bayesian tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingbayesianattempts'] = 'Upgrading bayesian attempts: bayesian {$a->done}/{$a->outof} (bayesian id {$a->info})';
$string['upgradingveryoldbayesianattempts'] = 'Upgrading very old bayesian attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this bayesian';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} bayesian attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this bayesian';
$string['yourfinalgradeis'] = 'Your final grade for this bayesian is {$a}.';
$string['questionversion'] = 'v{$a}';
$string['questionversionlatest'] = 'v{$a} (latest)';
$string['alwayslatest'] = 'Always latest';
$string['gobacktobayesian'] = 'Go back';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the bayesian settings) or higher.';
$string['completiondetail:passgrade'] = 'Receive a pass grade';
$string['gradetopassnotset'] = 'This bayesian does not yet have a grade to pass set. It may be set in the Grade section of the bayesian settings.';
$string['basicideasofbayesian'] = 'The basic ideas of bayesian-making';
