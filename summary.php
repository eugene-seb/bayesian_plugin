...
/**
 * This page prints a summary of a bayesian attempt before it is submitted.
 *
...
$PAGE->set_url('/mod/bayesian/summary.php', array('attempt' => $attemptid));
...
$navbc = $attemptobj->get_navigation_panel($output, 'bayesian_attempt_nav_panel', -1);
$regions = $PAGE->blocks->get_regions();
$PAGE->blocks->add_fake_block($navbc, reset($regions));

$PAGE->navbar->add(get_string('summaryofattempt', 'bayesian'));
